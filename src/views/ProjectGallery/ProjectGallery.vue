...
<template>
  <section class="w-full flex flex-col gap-10">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 80" width="30%">
      <path
    ...
    <div class="w-full flex flex-col gap-10">
      <p class="text-4xl tracking-wider font-semibold">
      ...
      <div class="w-full flex flex-col gap-5">
        ...
        <div class="w-full h-56 bg-blue-300 rounded-md"></div>
        <p class="text-md">
